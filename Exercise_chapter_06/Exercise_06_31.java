...
public class Exercise_06_31 {
    public static void main(String[] args){
        ...
        System.out.println(cardNumber + (isValid(cardNumber)? " is valid" : " is invalid"));
        input.close();
    }
    /** Return true if the card number is valid */
    public static boolean isValid(long number){
        ...
        if(!(prefixMatched(number, 4) || prefixMatched(number, 5) || prefixMatched(number, 37) || prefixMatched(number, 6))){ return false;}
    ...
    public static int sumOfDoubleEvenPlace(long number){
        ...
        for(int i = convertNumber.length()-2; i >= 0 ; i -= 2){
            sum += getDigit(Integer.parseInt(convertNumber.charAt(i) + "")*2);
        }
	...
	* return the sum of the two digits */
    ...
    public static int sumOfOddPlace(long number){
        ...
        for(int i = convertNumber.length()-1; i >= 0 ; i -= 2){
            sum += getDigit(Integer.parseInt(convertNumber.charAt(i) + ""));
        }
